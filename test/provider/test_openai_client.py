...
class TestOpenAiClient:
    ...
    def test_init_with_tools(self, mock_config_manager):
        ...
        client = OpenAiClient(model="gpt-4", temperature=0.7, tools=tools)
        assert client.tools == tools

    def test_query_llm_non_streaming(self, mock_openai_client, mock_memory, mock_openai_response):
    ...
    def test_query_llm_with_format(self, mock_openai_client, mock_memory, mock_openai_response):
    ...
    def test_query_llm_with_tools(self, mock_openai_client, mock_memory, mock_openai_response):
    ...
    def test_streaming_response(self, mock_openai_client, mock_memory):
    ...
    def test_error_handling(self, mock_openai_client, mock_memory):
    ...
    def test_build_final_response_without_choices(self, mock_openai_client, mock_memory):
    ...
    def test_build_final_response_without_content(self, mock_openai_client, mock_memory):
